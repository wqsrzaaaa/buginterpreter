        ...
        {messages.length > 1 ? (
          ...
          <div className="flex-1 p-4 space-y-4 items-center justify-center ">
            <div className="flex items-center justify-center flex-col gap-2">
              <div className='bluranimation bg-purple-800/60 rounded-full blur-2xl absolute -left-[20%] -top-[20%]'></div>
              <div className='bluranimation bg-blue-800/60 rounded-full blur-2xl absolute -right-[20%] -bottom-[20%]'></div>
