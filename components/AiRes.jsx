        ...
        <div className="flex-1 p-4 space-y-4 overflow-y-auto custom-scrollbar">
          {messages.map((msg, index) => (
            ...
            >
              ...
              <div
                className={`relative group px-4 mb-5 py-2 rounded-lg max-w-[70%] w-auto text-sm ${
                  msg.role === "user" ? "bg-blue-600 text-white" : "bg-hoverbg"
                }`}
              >
                ...
                {mounted && msg.createdAt && (
                  <div className="text-xs text-gray-400 mt-1">
                    {formatTime(
                      msg.createdAt instanceof Timestamp ? msg.createdAt.toDate() : new Date(msg.createdAt)
                    )}
                  </div>
                )}

                {/* bot copy button (for bot text) */}
